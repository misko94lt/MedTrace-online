...
const BASE = new Set(["FuncWizardForm","FuncVerifyForm","IecWizardForm","IECReportForm","TestInstrumentsHint"]);
const CHECK = ["AssetCombobox","ErrorSummary","SignaturePad","FORM_FLD","FORM_INP","FORM_LBL","cndToTemplate","guessTemplate","getNextReportNumber","iecGetMeasures","INSTRUMENTS_BY_TPL"];
