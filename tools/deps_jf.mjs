...
const GROUP = new Set(["JobForm", "JobDetailModal", "QuoteForm", "QuotesPage", "InvoiceForm", "generateJobPDF", "generateQuotePDF", "newQuoteNumber", "IVA_DEFAULT", "IVA_DEFAULT_Q", "IVA_RATES", "QUOTE_STATUS_COLOR"]);
