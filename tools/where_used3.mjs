...
const BASE = new Set(["InstrumentsPage","InstrumentForm","RecallsPage","TemplateEditor"]);
const CHECK = ["CATEGORIES","FilterDropdown","MobileSearch","RECALL_SEV_COLOR","RECALL_STATUSES","RECALL_STATUS_COLOR","RecallForm","RenewCalibrationForm","SwipeableCard","blankTemplate","errorBorderStyle"];
