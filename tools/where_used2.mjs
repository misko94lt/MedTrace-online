...
const BASE = new Set(["AssetForm","AssetDetailModal","ImportAssetsModal","TimelineModal","WithdrawalModal","StickerModal"]);
const CHECK = ["withCreateMeta","withUpdateMeta","fmtDateTimeIt","customerPrefix","nextAssetCode","jobShortCode","jobTipoLabel","compressImage","isCloudPhoto","uploadPhotoToCloud","deleteCloudPhoto","assetHasOpenRecall","assetOpenRecall","QRGen","Badge","PRI_COLOR","STATUS_COLOR","TIMELINE_ICON","TIMELINE_LABEL","FORM_FOOTER","IMP_FIELDS","impNorm","impEnsureXLSX","impEnum","impParseCSV","impToISO","impToNum","ICON_EDIT","CND_CAT"];
