...
const MEAS_TUTORIAL = {
pe: {
titolo: "Resistenza conduttore di protezione (PE)",
passi: [
"Collega il puntale di terra dell'analizzatore al morsetto PE/equipotenziale dell'apparecchio (sui fissi: il nodo di terra dell'impianto, non la spina).",
"Appoggia la sonda mobile su ogni parte metallica accessibile dell'involucro: vanno misurati più punti, non uno solo.",
"Avvia la misura (corrente di prova ≥ 200 mA). Tieni il valore PIÙ ALTO tra i punti come risultato.",
"Per apparecchi con cavo: fletti il cavo lungo tutta la lunghezza durante la misura, controlla che il valore non salti."
],
nota: "Il limite dipende dalla lunghezza del conduttore: su un fisso con conduttore lungo può essere > 0,3 Ω.",
svg: "pe"
},
encl: {
...
const lbl = { fill: "#94a3b8", fontSize: 11, fontFamily: "system-ui" };
...
React.createElement("text", Object.assign({ x: "30", y: "129" }, lbl), "nodo equipotenziale / PE impianto"),
...
setF(x => {
const fresh = getMeasures(x.norm, x.equipClass, x.patientType, x.leakageMethod, x.sfc !== false);
...
}, [f.norm, f.equipClass, f.patientType, f.leakageMethod, f.sfc]);
...
return (React.createElement("div", { key: m.id + "-tut", style: { background: "#0D1117", border: "1px solid #2DD4BF44", borderRadius: 8, padding: "12px 14px", marginBottom: 8, marginTop: -2 } },
React.createElement("div", { style: { fontSize: 12, fontWeight: 700, color: "#5EEAD4", marginBottom: 8 } },
"\uD83D\uDD0C Come mi collego \u2014 ",
tut.titolo),
