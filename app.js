...
passi: [
"Apparecchio alimentato e acceso, nelle normali condizioni d'uso (per gli interni a batteria: acceso).",
"Imposta l'analizzatore in modalità dispersione involucro / touch (lo strumento simula il corpo umano con la rete di misura ~1 kΩ).",
"Appoggia la sonda di misura sulle parti metalliche accessibili NON collegate a terra (carcassa, viti, connettori esterni, supporti).",
"Leggi la corrente: su apparecchio sano resta molto bassa. Limite ≤ 100 µA in condizione normale (NC)."
],
nota: "Sui fissi è la misura che sostituisce l'equipment leakage. L'interruzione del PE non si simula come primo guasto, quindi niente SFC sulla terra.",
svg: "encl"
},
pat: {
titolo: "Dispersione parte applicata (paziente)",
passi: [
"Collega insieme tutti i terminali della STESSA parte applicata (stessa funzione) e portali al morsetto P.A. dell'analizzatore.",
"Imposta sullo strumento il tipo corretto: B / BF / CF (lo trovi sull'etichetta dell'apparecchio o nei dati del costruttore).",
"Le parti CF si misurano una funzione alla volta; le BF puoi raggrupparle per funzione. Le tipo B in genere non si misurano a parte (sono incluse nell'involucro).",
"Leggi il valore e confronta col limite del tipo: BF ≤ 5000 µA, CF ≤ 50 µA. Il CF è molto più severo perché va al cuore."
],
nota: "Per la dispersione 'rete sulla parte applicata' (MAP) la parte applicata viene messa sotto tensione di rete: misura da fare con cautela e solo dove prevista.",
svg: "pat"
}
};
...
const C = { box: "#1a2030", boxStroke: "#3a4560", wireRef: "#38bdf8", wireProbe: "#f59e0b", wirePA: "#a855f7", txt: "#e2e8f0", sub: "#94a3b8" };
...
if (kind === "encl")
return (React.createElement("svg", { viewBox: "0 0 340 210", style: { width: "100%", maxWidth: 340, height: "auto" } },
React.createElement(Box, { x: 20, y: 30, w: 140, h: 85, label: "Apparecchio" }),
React.createElement("text", { x: 90, y: 102, textAnchor: "middle", fill: C.sub, fontSize: 9.5, fontFamily: "system-ui" }, "(alimentato e acceso)"),
React.createElement(Box, { x: 215, y: 35, w: 105, h: 75, label: "Analizzatore" }),
React.createElement(Dot, { x: 160, y: 55, c: C.wireProbe }),
React.createElement("path", { d: "M215 60 H160", stroke: C.wireProbe, strokeWidth: 2.5, fill: "none" }),
React.createElement("text", { x: 160, y: 24, textAnchor: "middle", fill: C.sub, fontSize: 10.5, fontFamily: "system-ui" }, "involucro (parti non a terra)"),
React.createElement(Leg, { x: 20, y: 188, c: C.wireProbe, t: "sonda di misura sull'involucro" })));
return (React.createElement("svg", { viewBox: "0 0 340 210", style: { width: "100%", maxWidth: 340, height: "auto" } },
React.createElement(Box, { x: 20, y: 35, w: 140, h: 90, label: "Apparecchio" }),
React.createElement(Dot, { x: 160, y: 55, c: C.wirePA }),
React.createElement(Dot, { x: 160, y: 80, c: C.wirePA }),
React.createElement(Dot, { x: 160, y: 105, c: C.wirePA }),
React.createElement("text", { x: 90, y: 140, textAnchor: "middle", fill: C.sub, fontSize: 9.5, fontFamily: "system-ui" }, "terminali della stessa parte applicata"),
React.createElement(Box, { x: 225, y: 45, w: 95, h: 70, label: "morsetto P.A." }),
React.createElement("path", { d: "M160 55 Q200 55 225 65", stroke: C.wirePA, strokeWidth: 2.5, fill: "none" }),
React.createElement("path", { d: "M160 80 H225", stroke: C.wirePA, strokeWidth: 2.5, fill: "none" }),
React.createElement("path", { d: "M160 105 Q200 105 225 95", stroke: C.wirePA, strokeWidth: 2.5, fill: "none" }),
React.createElement(Leg, { x: 20, y: 188, c: C.wirePA, t: "tutti i terminali insieme → morsetto P.A." })));
}
...
React.createElement("div", { style: { display: "grid", gridTemplateColumns: prevReport ? "1fr 70px 70px 50px 56px 44px" : "1fr 80px 80px 50px 50px", gap: 6, alignItems: "center", marginBottom: 6, background: "#0D0D12", borderRadius: 6, padding: "6px 8px" } },
React.createElement("span", { style: { fontSize: 11, color: "#94a3b8", display: "flex", alignItems: "center", gap: 5 } },
m.name,
tutorialFor(m.id, f.fixedInstall) && React.createElement("span", { onClick: () => setTutorialOpen(tutorialOpen === m.id ? null : m.id), title: "Come mi collego", style: { cursor: "pointer", color: "#2DD4BF", border: "1px solid #2DD4BF66", borderRadius: "50%", width: 15, height: 15, display: "inline-flex", alignItems: "center", justifyContent: "center", fontSize: 10, fontWeight: 700, flexShrink: 0 } }, "i")),
