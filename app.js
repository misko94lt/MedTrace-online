...
const MEAS_TUTORIAL = {
pe: {
titolo: "Resistenza di terra (nodo equipotenziale)",
passi: [
"Collega il puntale di riferimento dell'analizzatore al nodo equipotenziale dell'impianto.",
"Appoggia la sonda mobile su ogni parte metallica accessibile dell'involucro: misura più punti, non uno solo.",
"Avvia la misura (corrente di prova ≥ 200 mA). Tieni il valore PIÙ ALTO tra i punti come risultato."
],
nota: "Il limite dipende dalla lunghezza del conduttore: su un fisso può superare 0,3 Ω (campo modificabile).",
svg: "pe"
},
encl: {
...
React.createElement(Dot, { x: 150, y: 55, c: C.wireProbe }),
React.createElement("path", { d: "M210 55 H150", stroke: C.wireProbe, strokeWidth: 2.5, fill: "none" }),
React.createElement("text", { x: 150, y: 24, textAnchor: "middle", fill: C.sub, fontSize: 10.5, fontFamily: "system-ui" }, "parti metalliche"),
React.createElement(Dot, { x: 45, y: 150, c: C.wireRef }),
React.createElement("path", { d: "M45 110 V150", stroke: C.wireRef, strokeWidth: 2.5, fill: "none" }),
React.createElement("path", { d: "M265 110 V175 H45 V150", stroke: C.wireRef, strokeWidth: 2.5, fill: "none", strokeDasharray: "5 4" }),
React.createElement("text", { x: 55, y: 154, fill: C.sub, fontSize: 10.5, fontFamily: "system-ui" }, "nodo equipotenziale impianto"),
React.createElement(Leg, { x: 20, y: 205, c: C.wireProbe, t: "sonda mobile (parti metalliche)" }),
React.createElement(Leg, { x: 20, y: 222, c: C.wireRef, t: "riferimento (equipotenziale)" })));
if (kind === "encl")
...
React.createElement("input", { type: "checkbox", checked: !!f.fixedInstall, onChange: e => setF(x => (Object.assign(Object.assign({}, x), { fixedInstall: e.target.checked }))), style: { width: 16, height: 16, accentColor: "#2DD4BF" } }),
React.createElement("span", { style: { fontSize: 13, fontWeight: 600, color: "#e2e8f0" } }, "Apparecchio installato permanentemente"),
...
tutorialOpen === m.id && tutorialFor(m.id) && (() => {
const tut = tutorialFor(m.id);
