...
const __nowDel = new Date().toISOString();
if (onReplaceJobs)
onReplaceJobs((data.jobs || []).map(j => ids[j.id] ? Object.assign({}, j, { deleted: true, deletedAt: __nowDel, updatedAt: __nowDel }) : j));
...
React.createElement("span", { style: { fontSize: 12, color: "#64748b", whiteSpace: "nowrap" } }, "Ordina:"),
React.createElement("select", { value: mobileSort.func, onChange: e => updSort("func", e.target.value), style: { flex: 1, background: "#141418", color: "#e2e8f0", border: "1px solid #2a3040", borderRadius: 8, padding: "8px 10px", fontSize: 13 } },
...
React.createElement("span", { style: { fontSize: 12, color: "#64748b", whiteSpace: "nowrap" } }, "Ordina:"),
React.createElement("select", { value: mobileSort.iec, onChange: e => updSort("iec", e.target.value), style: { flex: 1, background: "#141418", color: "#e2e8f0", border: "1px solid #2a3040", borderRadius: 8, padding: "8px 10px", fontSize: 13 } },
React.createElement("option", { value: "num_asc" }, "Numero (1 \u2192 100)"),
React.createElement("option", { value: "num_desc" }, "Numero (100 \u2192 1)"),
React.createElement("option", { value: "date_desc" }, "Data (pi\u00F9 recenti)"),
React.createElement("option", { value: "date_asc" }, "Data (pi\u00F9 vecchie)"),
