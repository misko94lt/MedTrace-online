...
<div class="kv"><span class="kv-label">Matricola strumento</span><span class="kv-value" style="font-family:monospace">${rep.instrumentSerial || '—'}</span></div>
<div class="kv"><span class="kv-label">Scadenza taratura</span><span class="kv-value">${rep.instrumentCalExpiry || '—'}</span></div>
...
list.length > 0 && React.createElement("div", { style: { fontSize: 11.5, color: "#64748b" } },
"Selezionati: ",
React.createElement("span", { style: { color: "#cbd5e1" } }, list.join(", ")))));
}
...
React.createElement(Section, { icon: "\uD83E\uDDD1\u200D\uD83D\uDD27", title: "Tecnici" },
React.createElement(TecniciManager, { technicians: comp.technicians || [], onChange: arr => { setComp(x => (Object.assign(Object.assign({}, x), { technicians: arr }))); onUpdateCompany(Object.assign(Object.assign({}, company), { technicians: arr })); } })),
