...
React.createElement("div", { style: { background: "#16161C", border: "1px solid #1e293b", borderRadius: 14, padding: "14px 16px", marginTop: 12 } },
...
React.createElement("b", { style: { color: "#5EEAD4" } }, jobs.filter(j => j.type === "verifica" || j.type === "calibrazione").length),
"."),
React.createElement(Btn, { sm: true, onClick: cleanupAutoJobs }, "Sposta nel cestino")),
