...
v = null;
if (["labor_hours", "labor_rate", "travel_cost", "markup_pct", "min_qty", "qty", "sell_price", "service_interval", "interval_iec", "interval_func", "total", "unit_price", "price", "cost"].includes(sk) && v === "")
v = null;
out[sk] = v;
}
return out;
...
function FuncVerifyForm({ initial, assetId: propAssetId, assets, customers, existingReports, templates, instruments, onSave, onClose }) {
...
setF(x => (Object.assign(Object.assign({}, x), { instrument: txt })));
...
function IECReportForm({ initial, assetId: propAssetId, assets, customers, existingReports, instruments, onSave, onClose }) {
...
(instruments && instruments.length > 0) && (React.createElement("select", { value: "", onChange: e => { const ins = (instruments || []).find(i => i.id === e.target.value); if (ins) {
const txt = [ins.brand, ins.model].filter(Boolean).join(" ") + (ins.internalCode ? (" (" + ins.internalCode + ")") : "");
setF(x => (Object.assign(Object.assign({}, x), { instrument: txt, calNumber: ins.certNumber || x.calNumber })));
} }, style: Object.assign(Object.assign({}, INP), { marginBottom: 6 }) },
React.createElement("option", { value: "" }, "\u2014 Scegli tra i tuoi strumenti \u2014"),
(instruments || []).map(i => React.createElement("option", { key: i.id, value: i.id },
[i.brand, i.model].filter(Boolean).join(" "),
...
React.createElement(IECReportForm, { initial: modal.data || null, assetId: ((_d = modal.data) === null || _d === void 0 ? void 0 : _d.assetId) || modal.assetId || null, assets: assets, customers: customers, existingReports: iecReports, instruments: instruments, onSave: saveIecReport, onClose: popModal }))),
...
React.createElement(FuncVerifyForm, { initial: modal.data || null, assetId: ((_e = modal.data) === null || _e === void 0 ? void 0 : _e.assetId) || modal.assetId || null, assets: assets, customers: customers, existingReports: funcReports, templates: allTemplates, instruments: instruments, onSave: saveFuncReport, onClose: popModal }))),
