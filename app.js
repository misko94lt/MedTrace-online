...
m.editableLimit ? (React.createElement("input", { type: "text", value: m.limit, onChange: e => setF(x => (Object.assign(Object.assign({}, x), { measures: x.measures.map(mm => mm.id === m.id ? Object.assign(Object.assign({}, mm), { limit: e.target.value, limitVal: parseFloat(String(e.target.value).replace(/[^0-9.]/g, "")) || mm.limitVal }) : mm) }))), title: "Limite modificabile", style: { background: "#1a1f2e", border: "1px solid #2DD4BF44", borderRadius: 5, padding: "5px 7px", color: "#5EEAD4", fontSize: 12, fontFamily: "monospace", width: 70, outline: "none" } })) : (React.createElement("span", { style: { fontSize: 12, color: "#94a3b8", fontFamily: "monospace" } }, m.limit))),
React.createElement("div", { style: { display: "flex", alignItems: "center", gap: 5, flex: 1, minWidth: 120 } },
React.createElement("input", { type: "number", step: "0.001", value: m.value, onChange: e => setMeas(m.id, e.target.value), placeholder: "valore", style: { background: "#16161C", border: "1px solid #2a3040", borderRadius: 6, padding: "7px 9px", color: "#e2e8f0", fontSize: 14, outline: "none", fontFamily: "monospace", flex: 1, minWidth: 0 } }),
React.createElement("span", { style: { fontSize: 12, color: "#64748b", minWidth: 24 } }, m.unit)),
prevReport ? (React.createElement("span", { style: { fontSize: 18, fontWeight: 700, color: trend === "worse" ? "#ef4444" : trend === "better" ? "#22c55e" : "#475569" } }, trend === "worse" ? "▲" : trend === "better" ? "▼" : (ok === null ? "—" : ok ? "✓" : "✗"))) : (React.createElement("span", { style: { fontWeight: 700, fontSize: 18, color: ok === null ? "#475569" : ok ? "#22c55e" : "#ef4444" } }, ok === null ? "—" : ok ? "✓" : "✗"))))) : (React.createElement("div", { style: { display: "grid", gridTemplateColumns: prevReport ? "minmax(0,1fr) 70px 80px 50px 56px 44px" : "minmax(0,1fr) 90px 90px 56px 56px", gap: 8, alignItems: "center", marginBottom: 6, background: "#0D0D12", borderRadius: 6, padding: "7px 10px" } },
...
React.createElement("input", { type: "number", step: "0.001", value: m.value, onChange: e => setMeas(m.id, e.target.value), placeholder: "\u2014", style: { background: "#16161C", border: "1px solid #2a3040", borderRadius: 5, padding: "4px 7px", color: "#e2e8f0", fontSize: 12, outline: "none", fontFamily: "monospace", minWidth: 0 } }),
