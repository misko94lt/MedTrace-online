...
React.createElement("div", { style: { display: "grid", gridTemplateColumns: prevReport ? "minmax(0,1fr) 64px 64px 40px 50px 40px" : "minmax(0,1fr) 76px 78px 44px 44px", gap: 6, marginBottom: 6 } }, (prevReport ? ["Parametro", "Limite", "Valore", "Unità", "Prec.", "Trend"] : ["Parametro", "Limite", "Valore", "Unità", "Esito"]).map(h => React.createElement("div", { key: h, style: { fontSize: 9, color: "#475569", fontWeight: 700, textTransform: "uppercase" } }, h))),
