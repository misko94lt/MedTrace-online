...
!(typeof DEMO_LOCKED !== "undefined" && DEMO_LOCKED) && (typeof getSupa === "function") && getSupa() && (React.createElement("div", { style: { background: "#141418", borderRadius: 10, padding: "14px 16px", border: "1px solid #2a3040" } },
React.createElement("div", { style: { fontSize: 11, color: "#94a3b8", textTransform: "uppercase", letterSpacing: .8, fontWeight: 700, marginBottom: 8 } }, "Account"),
React.createElement("button", { onClick: () => __awaiter(this, void 0, void 0, function* () { if (confirm("Disconnettere l'account? Per rientrare servirà di nuovo il login (e la connessione).")) {
try {
yield supaSignOut();
}
catch (e) { }
window.location.reload();
} }), style: { background: "#ef444415", border: "1px solid #ef444433", borderRadius: 8, color: "#ef4444", padding: "9px 16px", cursor: "pointer", fontWeight: 700, fontSize: 13 } }, "Disconnetti account"))),
React.createElement("div", null,
...
React.createElement("span", { style: { fontSize: 10, color: "#334155", fontFamily: "monospace", letterSpacing: .5 } }, "v0.85"),
