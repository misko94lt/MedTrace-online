...
const MEAS_TUTORIAL = {
encl: {
titolo: "Corrente di dispersione dell'involucro (touch)",
passi: [
"Apparecchio alimentato e acceso nelle condizioni normali d'uso.",
"Appoggia la sonda di misura sulla parte conduttrice accessibile non collegata a terra.",
"Leggi la corrente di dispersione e confronta col limite (NC, e SFC se previsto).",
"Su apparecchio installato permanentemente l'interruzione di terra NON si simula come primo guasto."
],
nota: "È la misura chiave sugli apparecchi che non puoi scollegare dalla rete.",
svg: "encl"
},
pat: {
titolo: "Corrente di dispersione nel paziente (parte applicata)",
passi: [
"Collega tutti i terminali della stessa parte applicata insieme al morsetto P.A. dell'analizzatore.",
"Imposta il tipo di parte applicata corretto (B / BF / CF) sullo strumento.",
"Per le parti CF misura una parte applicata alla volta; per BF puoi raggrupparle per funzione.",
"Leggi il valore e confronta col limite del tipo selezionato (CF molto più severo di BF)."
],
nota: "BOZZA — adatta alla tua strumentazione (point-to-point) e alla situazione clinica.",
svg: "pat"
}
};
