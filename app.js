...
React.createElement("span", { style: { fontSize: 12.5, color: fail ? "#fecaca" : "#e2e8f0", fontWeight: fail ? 700 : 500, textDecoration: isNA ? "line-through" : "none", minWidth: 0, overflowWrap: "anywhere", lineHeight: 1.25 } }, m.name),
