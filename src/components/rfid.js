...
a.epc ? React.createElement("span", { style: { fontSize: 9.5, fontWeight: 800, color: "#f59e0b", background: "#f59e0b18", padding: "2px 6px", borderRadius: 4, whiteSpace: "nowrap" } }, __t("ha gi\u00e0 tag")) : null)),
!list.length && React.createElement("div", { style: { fontSize: 11.5, color: "var(--text-3)", fontStyle: "italic", padding: "6px 2px" } }, __t("Nessun risultato"))),
React.createElement("div", { style: { borderTop: "1px solid var(--border-2)", marginTop: 8, paddingTop: 8 } },
React.createElement("div", { style: { fontSize: 10.5, color: "var(--text-3)", fontWeight: 700, marginBottom: 5 } }, __t("Oppure segna come TAG-REPARTO (scansionarlo imposter\u00e0 il reparto):")),
