...
React.createElement("div", { style: { fontSize: 18, fontWeight: 900, color: "var(--text-bright)", lineHeight: 1.2 } }, asset.name || __t("Apparecchio")),
...
React.createElement("div", { style: { fontSize: 9.5, color: "var(--text-3)", textTransform: "uppercase", letterSpacing: .6, fontWeight: 700, marginBottom: 5 } }, __t("Descrizione lavoro")),
...
React.createElement("div", { style: { fontSize: 9.5, color: "var(--text-3)", textTransform: "uppercase", letterSpacing: .6, fontWeight: 700, marginBottom: 5 } }, __t("Note")),
...
React.createElement("div", { style: { fontSize: 9.5, color: "var(--text-3)", textTransform: "uppercase", letterSpacing: .6, fontWeight: 700 } }, __t("Manodopera")),
...
React.createElement("div", { style: { fontSize: 9.5, color: "var(--text-3)", textTransform: "uppercase", letterSpacing: .6, fontWeight: 700 } }, __t("Ricambi")),
...
React.createElement("div", { style: { fontSize: 9.5, color: "#5eead4", textTransform: "uppercase", letterSpacing: .6, fontWeight: 700 } }, __t("Totale")),
...
(totMin / 60).toFixed(1),
"h totali")),
sortedSteps.length === 0 ? (React.createElement("div", { style: { textAlign: "center", color: "var(--text-4)", padding: "20px 0", fontSize: 12.5, background: "var(--bg-2)", borderRadius: 10, border: "1px dashed #24242F" } }, __t("Nessuna voce nello storico. Usa \"Modifica cronologia\" per aggiungere cosa \u00E8 stato fatto, quando e da chi."))) : (React.createElement("div", null, sortedSteps.map((step, i) => (React.createElement("div", { key: step.id || i, style: { display: "flex", gap: 14, marginBottom: 14 } },
