...
gruppi.length,
" clienti"),
React.createElement("button", { onClick: exportAll, style: { background: "#2dd4bf15", border: "1px solid #2dd4bf44", borderRadius: 8, color: "#2dd4bf", padding: "8px 13px", fontSize: 12, fontWeight: 700, cursor: "pointer" } }, "Esporta tutto in Excel"))),
...
React.createElement("button", { onClick: () => copy(body, "testo"), style: { background: "transparent", border: "1px solid var(--border)", borderRadius: 8, color: "var(--text-2)", padding: "9px 13px", fontSize: 12, fontWeight: 700, cursor: "pointer" } }, copied === "testo" ? "✓ Copiato" : __t("Copia testo")),
React.createElement("a", { href: mailtoUrl, style: { background: "#2dd4bf", border: "none", borderRadius: 8, color: "#04201C", padding: "9px 15px", fontSize: 13, fontWeight: 800, cursor: "pointer", textDecoration: "none" } }, "\u2709 Apri nell'app email"))));
}
