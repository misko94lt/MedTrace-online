...
React.createElement("span", { style: { fontSize: 10, fontWeight: 700, color: s.tipoKind === "iec" ? "#c084fc" : "#5eead4", background: (s.tipoKind === "iec" ? "#a855f7" : "#1F7468") + "22", border: "1px solid " + (s.tipoKind === "iec" ? "#a855f7" : "#1F7468") + "44", borderRadius: 4, padding: "1px 6px" } }, s.tipoKind === "iec" ? __t("Sic. Elettrica") : __t("Funzionale"))),
...
React.createElement("h1", { style: { margin: "0 0 4px", fontSize: 22, fontWeight: 800, color: "var(--text-bright)" } }, __t("Scadenze & Promemoria")),
...
borderRadius: 10, padding: "10px 8px", cursor: "pointer", color: on ? "#04201C" : "var(--text-strong)",
...
gruppi.length,
" clienti"),
React.createElement("button", { onClick: exportAll, style: { background: "#2dd4bf15", border: "1px solid #2dd4bf44", borderRadius: 8, color: "#2dd4bf", padding: "8px 13px", fontSize: 12, fontWeight: 700, cursor: "pointer" } }, __t("Esporta tutto in Excel")))),
...
React.createElement("div", { style: { fontSize: 12, color: "var(--text-2)", lineHeight: 1.5, marginBottom: 14 } },
...
React.createElement("button", { onClick: exportExcel, style: { background: "#2dd4bf15", border: "1px solid #2dd4bf44", borderRadius: 8, color: "#2dd4bf", padding: "10px 14px", fontSize: 13, fontWeight: 700, cursor: "pointer", width: "100%" } },
__t("Scarica Excel da allegare ("),
items.length,
" apparecchi)"))),
...
React.createElement("button", { onClick: () => copy(body, "testo"), style: { background: "transparent", border: "1px solid var(--border)", borderRadius: 8, color: "var(--text-2)", padding: "9px 13px", fontSize: 12, fontWeight: 700, cursor: "pointer" } }, copied === "testo" ? __t("✓ Copiato") : __t("Copia testo")),
React.createElement("a", { href: mailtoUrl, style: { background: "#2dd4bf", border: "none", borderRadius: 8, color: "#04201C", padding: "9px 15px", fontSize: 13, fontWeight: 800, cursor: "pointer", textDecoration: "none" } }, __t("\u2709 Apri nell'app email")))));
}
...
const Bar = ({ h, color, title }) => React.createElement("div", { title: title, style: { height: Math.max(h > 0 ? 2 : 0, h), background: color, borderRadius: 4 } });
return (React.createElement("div", null,
...
React.createElement("h1", { style: { margin: 0, fontSize: isMobile ? 14 : 18, fontWeight: 800, display: isMobile ? "none" : "block" } }, __t("KPI & Statistiche")),
React.createElement("p", { style: { color: "var(--text-3)", margin: isMobile ? 0 : "2px 0 0", fontSize: 12, fontFamily: "'IBM Plex Mono', monospace" } },
K.nAssets,
__t(" apparecchi nel filtro"))),
...
React.createElement("div", { style: { fontSize: 11, color: "var(--text-3)", marginTop: 6 } },
K.nChiusi,
__t(" correttivi chiusi nel periodo"))),
React.createElement("div", { style: card },
...
React.createElement("div", { style: { fontSize: 11, color: "var(--text-3)", marginTop: 6 } }, __t("stesso apparecchio, nuovo guasto")))),
...
React.createElement("div", { style: { fontSize: 11, color: "var(--text-3)", marginTop: 6 } }, K.nGuasti + __t(" guasti nel periodo \u00b7 stima"))),
React.createElement("div", { style: card },
...
React.createElement("div", { style: { fontSize: 11, color: "var(--text-3)", marginTop: 6 } }, K.nClosedP + __t(" chiusi su ") + K.nOpenedP + __t(" aperti"))),
React.createElement("div", { style: card },
...
React.createElement("div", { style: { fontSize: 10, color: "var(--text-3)", textAlign: "center", marginTop: 3 } },
m.label,
...
React.createElement("div", null,
React.createElement("h1", { style: { margin: 0, fontSize: 18, fontWeight: 800 } }, __t("Agenda & Pianificazione")),
...
" ",
viewYear),
monthOffset !== 0 && React.createElement("button", { onClick: () => setMonthOffset(0), style: { background: 'none', border: 'none', color: '#2dd4bf', fontSize: 10, cursor: 'pointer', padding: 0, marginTop: 2 } }, __t("\u21A9 Torna a oggi"))),
React.createElement("button", { onClick: () => setMonthOffset(monthOffset + 1), style: { background: 'var(--surface)', border: '1px solid #2a3040', borderRadius: 8, color: 'var(--text-2)', padding: '7px 14px', cursor: 'pointer', fontSize: 16 } }, "\u203A")),
...
React.createElement("div", { style: { fontSize: 26, fontWeight: 800, color: '#2dd4bf', fontFamily: 'monospace', lineHeight: 1 } }, stats.total),
...
React.createElement("div", { style: { fontSize: 26, fontWeight: 800, color: '#ef4444', fontFamily: 'monospace', lineHeight: 1 } }, stats.overdue),
...
React.createElement("div", { style: { background: 'var(--surface)', border: '1px solid #1e2a3a', borderRadius: 10, padding: '12px 14px' } },
React.createElement("div", { style: { fontSize: 26, fontWeight: 800, color: '#f59e0b', fontFamily: 'monospace', lineHeight: 1 } }, stats.thisWeek),
...
React.createElement("div", { style: { background: 'var(--surface)', border: '1px solid #1e2a3a', borderRadius: 10, padding: '12px 14px' } },
React.createElement("div", { style: { fontSize: 26, fontWeight: 800, color: 'var(--text-2)', fontFamily: 'monospace', lineHeight: 1 } }, byClient.length),
...
borderRadius: 20, padding: '4px 13px', cursor: 'pointer', fontSize: 12, fontWeight: 700,
} }, f.label)))),
...
React.createElement("div", null,
React.createElement("h3", { style: { margin: 0, fontSize: 14, fontWeight: 800, color: 'var(--text-bright)' } }, __t("Piano Manutenzione Manuale")),
...
React.createElement("option", { value: "" }, __t("\u2014 Mese \u2014")),
...
items.length > 0 && (React.createElement("span", { style: { background: '#2dd4bf', color: '#000', borderRadius: 20, padding: '1px 7px', fontSize: 10, fontWeight: 800 } }, items.length))),
