...
React.createElement(Btn, { sm: true, onClick: addBulk }, __t("+ Aggiungi"))),
...
React.createElement(Btn, { sm: true, variant: "ghost", onClick: addItem }, __t("+ Riga"))),
f.items.length > 0 && (React.createElement("div", { style: { display: "grid", gridTemplateColumns: "1fr 70px 90px 60px auto", gap: 6, padding: "0 10px 4px", fontSize: 10, color: "var(--text-3)", textTransform: "uppercase", letterSpacing: .5, fontWeight: 700 } },
...
React.createElement("div", null,
React.createElement("button", { onClick: () => setShowDetails(v => !v), style: { width: "100%", display: "flex", alignItems: "center", justifyContent: "space-between", background: "var(--surface)", border: "1px solid var(--border)", borderRadius: 8, padding: "10px 14px", cursor: "pointer", color: "var(--text-2)", fontSize: 13, fontWeight: 600 } },
React.createElement("span", null,
__t("Altri dettagli "),
...
React.createElement("option", { value: "" }, __t("\u2014 Seleziona cliente \u2014")),
customers.map(c => React.createElement("option", { key: c.id, value: c.id }, c.name)))),
React.createElement("div", null,
...
React.createElement("option", { value: "" }, __t("\u2014 Nessuno / importa manuale \u2014")),
customerJobs.map(j => {
const a = assets.find(a => a.id === j.assetId);
...
f.laborLines.length,
" voci)"),
React.createElement("button", { onClick: addLabor, style: { background: 'var(--surface-2)', border: '1px solid #2dd4bf44', borderRadius: 6, color: '#2dd4bf', padding: '4px 12px', cursor: 'pointer', fontSize: 11, fontWeight: 700 } }, __t("+ Voce"))),
...
React.createElement("button", { onClick: () => delLabor(l.id), style: { background: '#ef444415', border: '1px solid #ef444430', borderRadius: 6, color: '#ef4444', padding: '6px 8px', cursor: 'pointer', fontSize: 11 } }, "\u2715")))),
...
React.createElement("button", { onClick: addPartFree, style: { background: 'var(--surface-2)', border: '1px solid #a855f744', borderRadius: 6, color: '#a855f7', padding: '4px 10px', cursor: 'pointer', fontSize: 11, fontWeight: 700 } }, __t("+ Riga libera")))),
...
React.createElement("div", null,
l.type === 'warehouse' && (React.createElement("div", { style: { fontSize: 10, color: '#a855f7', fontWeight: 700, marginBottom: 2 } }, "MAGAZZINO")),
...
r,
"%"))),
React.createElement("button", { onClick: () => delPart(l.id), style: { background: '#ef444415', border: '1px solid #ef444430', borderRadius: 6, color: '#ef4444', padding: '6px 8px', cursor: 'pointer', fontSize: 11 } }, "\u2715")))),
...
React.createElement("div", null,
React.createElement("h1", { style: { margin: 0, fontSize: 20, fontWeight: 800 } }, __t("Preventivi")),
React.createElement("p", { style: { color: 'var(--text-3)', margin: '3px 0 0', fontSize: 12 } }, __t("Quotazioni da job \u2192 PDF professionale"))),
React.createElement("button", { onClick: () => setModal({ type: 'form', data: null }), style: FORM_BTN_PRIMARY }, __t("+ Nuovo preventivo"))),
...
React.createElement("div", { style: { fontSize: 20, fontWeight: 800, color: k.color, fontFamily: 'monospace' } }, k.value),
...
React.createElement("div", { style: { marginBottom: 10, opacity: .35, display: "flex", justifyContent: "center" } }, React.createElement("svg", { width: 40, height: 40, viewBox: "0 0 24 24", fill: "none", stroke: "var(--text-3)", strokeWidth: 1.6, strokeLinecap: "round", strokeLinejoin: "round" }, React.createElement("path", { d: "M21 8a2 2 0 0 0-1-1.73l-7-4a2 2 0 0 0-2 0l-7 4A2 2 0 0 0 3 8v8a2 2 0 0 0 1 1.73l7 4a2 2 0 0 0 2 0l7-4A2 2 0 0 0 21 16Z" }), React.createElement("path", { d: "m3.3 7 8.7 5 8.7-5" }), React.createElement("path", { d: "M12 22V12" }))),
...
React.createElement("button", { onClick: () => setModal({ type: 'form', data: null }), style: FORM_BTN_PRIMARY }, __t("+ Nuovo preventivo")))) : __t('Nessun risultato'))) : (React.createElement("div", { style: { display: 'flex', flexDirection: 'column', gap: 8 } }, filtered.slice().sort((a, b) => (b.createdAt || '').localeCompare(a.createdAt || '')).map(q => {
var _a, _b, _c;
...
React.createElement("span", { style: { fontFamily: 'monospace', fontWeight: 800, fontSize: 14, color: 'var(--text-bright)' } }, q.number),
...
React.createElement("div", { style: { fontSize: 18, fontWeight: 800, color: '#22c55e', fontFamily: 'monospace' } },
"\u20AC",
grand.toFixed(2)),
